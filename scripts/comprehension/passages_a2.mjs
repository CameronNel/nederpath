export const passages = [
  {
    ...
    vocab: [
      { word: "het verzorgingshuis", en: "care home", pos: "noun" },
      { word: "de bewoner", en: "resident", pos: "noun" },
      { word: "de medicijnen", en: "medicines", pos: "noun" },
      { word: "de rollator", en: "walker", pos: "noun" },
      { word: "het dossier", en: "file / record", pos: "noun" },
      { word: "uitdelen", en: "to hand out", pos: "verb" }
    ],
    grammarTargets: ["Subordinate clause with 'omdat'", "Conditional 'als'"],
    questions: [
      { question: "Hoeveel avonden per week werkt Farah?", options: ["Drie", "Vijf", "Eén", "Zeven"], correct: 0, explanation: "Ze werkt drie avonden per week." },
      { question: "Waarom begint ze om vier uur?", options: ["Omdat de bus dan stopt", "Omdat de bewoners dan koffie drinken en medicijnen krijgen", "Omdat ze eerder vrij is", "Omdat de keuken sluit"], correct: 1, explanation: "Ze begint om vier uur, omdat de bewoners dan koffie drinken en medicijnen krijgen." },
      { question: "Wat schrijft Farah om half tien?", options: ["Een brief naar huis", "Een recept", "Wat er is gebeurd in het digitale dossier", "Haar boodschappenlijst"], correct: 2, explanation: "Ze schrijft in het digitale dossier wat er is gebeurd." },
      { question: "Wat checkt ze voordat ze naar huis fietst?", options: ["De ramen van de kerk", "Haar e-mail", "De oven", "De deuren"], correct: 3, explanation: "Ze checkt de deuren en fietst naar huis." }
    ]
  },
  {
    id: "comp-026",
    ...
    vocab: [
      { word: "verhuizen", en: "to move house", pos: "verb" },
      { word: "inschrijven", en: "to register", pos: "verb" },
      { word: "het huurcontract", en: "rental contract", pos: "noun" },
      { word: "de bevestiging", en: "confirmation", pos: "noun" },
      { word: "de toeslag", en: "allowance / benefit", pos: "noun" },
      { word: "activeren", en: "to activate", pos: "verb" }
    ],
    grammarTargets: ["Subordinate clause with 'omdat'", "Purpose clause with 'zodat'"],
    questions: [
      { question: "Van welke stad is Tibor verhuisd?", options: ["Utrecht", "Venlo", "Groningen", "Haarlem"], correct: 1, explanation: "Hij is verhuisd van Venlo naar Breda." },
      { question: "Wat neemt hij mee naar de gemeente?", options: ["Alleen een fiets", "Een koffer kleren", "Zijn huurcontract en paspoort", "Zijn belastingaangifte van vijf jaar"], correct: 2, explanation: "Hij neemt zijn huurcontract en paspoort mee." },
      { question: "Wat is de ingangsdatum op het papier?", options: ["1 januari", "15 mei", "31 december", "1 maart"], correct: 3, explanation: "Tibor wijst naar 1 maart op het papier." },
      { question: "Waarom moet hij een DigiD activeren?", options: ["Zodat hij later toeslagen kan aanvragen", "Zodat hij een auto kan kopen", "Omdat de trein dat eist", "Omdat hij naar het buitenland gaat"], correct: 0, explanation: "Hij moet een DigiD activeren, zodat hij later toeslagen kan aanvragen." }
    ]
  },
  {
    id: "comp-027",
    ...
    vocab: [
      ...
      { word: "de omvormer", en: "inverter", pos: "noun" },
      { word: "opwekken", en: "to generate", pos: "verb" },
      { word: "het net", en: "grid", pos: "noun" },
      { word: "de opbrengst", en: "yield", pos: "noun" }
    ],
    grammarTargets: ["Causal 'daarom'", "Subordinate clause with 'omdat'"],
    questions: [
      { question: "Hoeveel zonnepanelen laat de familie zetten?", options: ["Twee", "Twaalf", "Acht", "Twintig"], correct: 2, explanation: "Ze laten acht zonnepanelen op het dak zetten." },
      { question: "Waar hangt de omvormer?", options: ["In de keuken", "Op zolder", "In de auto", "In de schuur"], correct: 3, explanation: "De monteur legt uit dat de omvormer in de schuur hangt." },
      { question: "Hoeveel kilowattuur hebben de panelen al opgewekt?", options: ["Honderd", "Tien", "Duizend", "Nul"], correct: 0, explanation: "De panelen hebben al honderd kilowattuur opgewekt." },
      { question: "Waarom zetten de kinderen de wasdroger uit?", options: ["Omdat hij kapot is", "Omdat ze de opbrengst willen vergelijken", "Omdat het regent", "Omdat oma dat vraagt"], correct: 1, explanation: "Ze zetten de droger uit, omdat ze de opbrengst willen vergelijken." }
    ]
  },
  {
    id: "comp-028",
    ...
    vocab: [
      ...
      { word: "het raadslid", en: "councillor", pos: "noun" },
      { word: "de inspraakavond", en: "public consultation evening", pos: "noun" },
      { word: "de aflevering", en: "episode", pos: "noun" },
      { word: "de agenda", en: "agenda", pos: "noun" }
    ],
    grammarTargets: ["Subordinate clause with 'omdat'", "Conditional 'als'"],
    questions: [
      { question: "Waarom neemt Nienke op in de keuken?", options: ["Omdat de microfoon daar beter is", "Omdat de studio te duur is", "Omdat de buren dat vragen", "Omdat het stadhuis dicht is"], correct: 1, explanation: "Ze neemt op in haar keuken, omdat de studio te duur is." },
      { question: "Waarover kunnen inwoners iets zeggen op de inspraakavond volgens haar uitleg?", options: ["Over voetbal", "Over vakantie", "Over parkeren", "Over koken"], correct: 2, explanation: "Ze legt uit hoe inwoners iets over parkeren kunnen zeggen." },
      { question: "Hoeveel mensen luisteren op de eerste dag?", options: ["Tien", "Duizend", "Vijftig", "Honderd"], correct: 3, explanation: "Honderd mensen luisteren op de eerste dag." },
      { question: "Wat gaat de luisteraar volgende week doen?", options: ["Zelf naar het stadhuis gaan", "Een nieuwe podcast starten", "Verhuizen", "Stoppen met luisteren"], correct: 0, explanation: "Hij gaat volgende week zelf naar het stadhuis." }
    ]
  },
  {
    id: "comp-029",
    ...
    vocab: [
      ...
      { word: "de receptionist", en: "receptionist", pos: "noun" },
      { word: "aankomen", en: "to arrive", pos: "verb" }
    ],
    grammarTargets: ["Separable verbs 'uitvallen/aankomen'", "Purpose clause with 'zodat'"],
    questions: [
      { question: "Hoe laat is het sollicitatiegesprek?", options: ["Om acht uur", "Om twaalf uur", "Om half elf", "Om drie uur"], correct: 2, explanation: "Het gesprek is om half elf." },
      { question: "Waarom valt de sprinter uit?", options: ["Vanwege sneeuw", "Vanwege staking", "Vanwege een volle trein", "Vanwege een seinstoring"], correct: 3, explanation: "De sprinter kan uitvallen vanwege een seinstoring." },
      { question: "Hoeveel later komt Boaz aan?", options: ["Twintig minuten later", "Een uur later", "Twee uur later", "Op tijd"], correct: 0, explanation: "Hij komt twintig minuten later aan." },
      { question: "Waarom begint het gesprek toch rustig?", options: ["Omdat hij cadeaus meebrengt", "Omdat hij eerlijk uitlegt wat er gebeurde", "Omdat de recruiter te laat is", "Omdat de trein stilstaat"], correct: 1, explanation: "Omdat hij eerlijk uitlegt wat er gebeurde, begint het gesprek rustig." }
    ]
  },
  {
    id: "comp-030",
    ...
    vocab: [
      { word: "de huiswerkbegeleiding", en: "homework support", pos: "noun" },
      { word: "de mentor", en: "mentor / tutor", pos: "noun" },
      { word: "de planning", en: "schedule / plan", pos: "noun" },
      { word: "het kladblok", en: "notepad", pos: "noun" },
      { word: "de samenvatting", en: "summary", pos: "noun" },
      { word: "inleveren", en: "to hand in", pos: "verb" }
    ],
    grammarTargets: ["Conditional 'als'", "Purpose clause with 'zodat'"],
    questions: [
      { question: "Op welke dag blijft Sanne na school?", options: ["Op maandag", "Op vrijdag", "Op zondag", "Op dinsdag"], correct: 3, explanation: "Elke dinsdag blijft ze na school." },
      { question: "Waarom legt de mentor een planning uit?", options: ["Omdat Sanne vaak te laat begint", "Omdat de school sluit", "Omdat Engels verplicht is", "Omdat ze gaat verhuizen"], correct: 0, explanation: "De mentor legt een planning uit, omdat ze vaak te laat begint." },
      { question: "Waarmee helpt Sanne haar klasgenoot?", options: ["Met gym", "Met aardrijkskunde", "Met koken", "Met muziek"], correct: 1, explanation: "Sanne helpt hem met aardrijkskunde." },
      { question: "Wat zet ze thuis weg?", options: ["Haar tas", "Haar jas", "Haar telefoon", "Haar fiets"], correct: 2, explanation: "Thuis zet ze haar telefoon weg." }
    ]
  },
  {
    id: "comp-031",
    ...
    vocab: [
      { word: "de lekkage", en: "leak", pos: "noun" },
      { word: "het plafond", en: "ceiling", pos: "noun" },
      { word: "de hoofdkraan", en: "main tap", pos: "noun" },
      { word: "de loodgieter", en: "plumber", pos: "noun" },
      { word: "de leiding", en: "pipe", pos: "noun" },
      { word: "de verzekering", en: "insurance", pos: "noun" }
    ],
    grammarTargets: ["Separable verb 'dichtdraaien/neerzetten'", "Subordinate clause with 'omdat'"],
    questions: [
      { question: "Wat doet Kenji eerst met het water?", options: ["Hij belt de politie", "Hij draait de hoofdkraan dicht", "Hij gaat zwemmen", "Hij schildert het plafond"], correct: 1, explanation: "Hij draait de hoofdkraan dicht." },
      { question: "Wat zit er los volgens de loodgieter?", options: ["Een raam", "Een deur", "Een koppeling", "Een tegel"], correct: 2, explanation: "Hij zegt dat een koppeling loszit." },
      { question: "Waar slaapt Kenji die nacht?", options: ["In de badkamer", "Bij de buren", "In een hotel", "Op de bank"], correct: 3, explanation: "Hij slaapt die nacht op de bank." },
      { question: "Naar wie stuurt hij de foto's?", options: ["Naar de verzekering", "Naar school", "Naar de krant", "Naar de bakker"], correct: 0, explanation: "Hij stuurt de foto's naar de verzekering." }
    ]
  },
  {
    id: "comp-032",
  ...
  },
  {
    ...
    vocab: [
      ...
      { word: "de eregalerij", en: "gallery of honour", pos: "noun" },
      { word: "het schilderij", en: "painting", pos: "noun" },
      { word: "de prent", en: "print", pos: "noun" },
      { word: "de vijver", en: "pond", pos: "noun" }
    ],
    grammarTargets: ["Purpose clause with 'zodat'", "Contrast with 'toch'"],
    questions: [
  ...
  },
  {
    ...
    vocab: [
      ...
      { word: "het e-consult", en: "e-consultation", pos: "noun" },
      { word: "de hoest", en: "cough", pos: "noun" },
      { word: "de apotheek", en: "pharmacy", pos: "noun" },
      { word: "de herinnering", en: "reminder", pos: "noun" }
    ],
    grammarTargets: ["Separable verb 'aanmaken/ophalen'", "Purpose clause with 'zodat'"],
    questions: [
      { question: "Waarom maakt mevrouw Karimi een account aan?", options: ["Omdat ze games wil spelen", "Omdat ze een nieuwe telefoon verkoopt", "Omdat ze herhaalrecepten niet meer telefonisch wil aanvragen", "Omdat de praktijk sluit"], correct: 2, explanation: "Ze maakt een account aan, omdat ze herhaalrecepten niet meer telefonisch wil aanvragen." },
      { question: "Hoe lang houdt haar hoest al aan?", options: ["Twee dagen", "Een maand", "Een uur", "Tien dagen"], correct: 3, explanation: "Haar hoest houdt al tien dagen aan." },
      { question: "Waar mag ze een kuur ophalen?", options: ["Bij de apotheek om de hoek", "In het ziekenhuis in Utrecht", "Op school", "Bij de supermarkt"], correct: 0, explanation: "Ze mag een kuur ophalen bij de apotheek om de hoek." },
      { question: "Waarom zet ze een herinnering?", options: ["Zodat ze de bus haalt", "Zodat ze de tabletten op tijd inneemt", "Zodat ze kan slapen", "Zodat de app sluit"], correct: 1, explanation: "Ze zet een herinnering, zodat ze de tabletten op tijd inneemt." }
    ]
  },
  {
    id: "comp-035",
    ...
    vocab: [
      ...
      { word: "de gevel", en: "façade", pos: "noun" },
      { word: "het stoofvlees", en: "stew", pos: "noun" },
      { word: "de ansichtkaart", en: "postcard", pos: "noun" },
      { word: "het museum", en: "museum", pos: "noun" }
    ],
    grammarTargets: ["Separable verb 'overstappen'", "Conditional 'als'"],
    questions: [
      { question: "Waar stapt Mila over?", options: ["In Utrecht", "In Antwerpen", "In Brussel", "In Luik"], correct: 1, explanation: "Ze moet in Antwerpen overstappen naar Gent." },
      { question: "Waarom fotografeert ze de gevels?", options: ["Omdat het regent", "Omdat het museum sluit", "Omdat het licht geel is", "Omdat ze verdwaalt"], correct: 2, explanation: "Ze fotografeert de gevels, omdat het licht geel is." },
      { question: "Voor wie koopt ze een ansichtkaart?", options: ["Voor haar baas", "Voor haar docent", "Voor haar buurman", "Voor haar moeder"], correct: 3, explanation: "Ze koopt een ansichtkaart voor haar moeder." },
      { question: "Waarom leest ze in de trein terug?", options: ["Zodat ze niet te moe aankomt op haar werk", "Omdat ze een toets heeft", "Omdat de wifi uitvalt", "Omdat ze haar vrienden mist"], correct: 0, explanation: "Ze leest, zodat ze niet te moe aankomt op haar werk." }
    ]
  },
  {
    id: "comp-036",
    ...
    vocab: [
      ...
      { word: "het whiteboard", en: "whiteboard", pos: "noun" },
      { word: "de spoelbak", en: "sink", pos: "noun" }
    ],
  ...
  },
  {
    ...
    vocab: [
      ...
      { word: "meten", en: "to measure", pos: "verb" },
      { word: "de liniaal", en: "ruler", pos: "noun" },
      { word: "de voedingsstof", en: "nutrient", pos: "noun" },
      { word: "het zand", en: "sand", pos: "noun" }
    ],
    grammarTargets: ["Purpose clause with 'zodat'", "Subordinate clause with 'omdat'"],
    questions: [
      { question: "Wat planten de leerlingen?", options: ["Tomaten", "Bomen", "Sla", "Bloemen"], correct: 2, explanation: "Ze planten sla in twee bakken." },
      { question: "Wat zit er in de tweede bak?", options: ["Alleen klei", "Alleen stenen", "Alleen water", "Alleen zand"], correct: 3, explanation: "In de andere bak gebruiken ze alleen zand." },
      { question: "Hoe meten ze de bladeren?", options: ["Met een liniaal", "Met een weegschaal", "Met een thermometer", "Met een camera alleen"], correct: 0, explanation: "Ze meten de bladeren met een liniaal." },
      { question: "Wat geeft compost volgens de leerling?", options: ["Licht", "Voedingsstoffen", "Zand", "Wind"], correct: 1, explanation: "Compost geeft voedingsstoffen, zodat de plant beter groeit." }
    ]
  },
  {
    id: "comp-038",
  ...
  },
  {
    ...
    vocab: [
      ...
      { word: "het stembureau", en: "polling station", pos: "noun" },
      { word: "het stemhokje", en: "voting booth", pos: "noun" },
      { word: "de vrijwilliger", en: "volunteer", pos: "noun" },
      { word: "zenuwachtig", en: "nervous", pos: "adjective" }
    ],
    grammarTargets: ["Concession with 'maar'", "Subordinate clause with 'omdat'"],
    questions: [
      { question: "Welke kleur heeft de stempas?", options: ["Blauw", "Geel", "Roze", "Groen"], correct: 2, explanation: "Hij krijgt een roze stempas." },
      { question: "Waar is het stembureau?", options: ["In de bibliotheek", "In het stadhuis", "In een winkel", "In de sporthal"], correct: 3, explanation: "Hij gaat naar het stembureau in de sporthal." },
      { question: "Wat neemt Yusuf mee?", options: ["Zijn identiteitskaart", "Alleen een briefje", "Zijn fietsbel", "Een krant"], correct: 0, explanation: "Hij neemt zijn identiteitskaart mee." },
      { question: "Waarom legt hij het hokje uit aan een buurman?", options: ["Omdat de buurman te laat is", "Zodat die minder zenuwachtig is", "Omdat hij kandidaat is", "Omdat de bus vol is"], correct: 1, explanation: "Hij legt het uit, zodat de buurman minder zenuwachtig is." }
    ]
  },
  {
    id: "comp-040",
    ...
    vocab: [
      ...
      { word: "het zout", en: "salt", pos: "noun" },
      { word: "de zuurkool", en: "sauerkraut", pos: "noun" },
      { word: "stampen", en: "to pound / mash", pos: "verb" },
      { word: "knapperig", en: "crunchy", pos: "adjective" }
    ],
    grammarTargets: ["Conditional 'als'", "Purpose clause with 'zodat'"],
    questions: [
      { question: "Waar volgt Bente de workshop?", options: ["In een restaurant", "In een buurthuis in Nijmegen", "Op een boerderij", "In een museum"], correct: 1, explanation: "Ze volgt de workshop in een buurthuis in Nijmegen." },
      { question: "Waarom moeten de stukken kool kleiner?", options: ["Omdat ze mooier zijn", "Omdat de pot klein is", "Omdat het zout dan beter werkt", "Omdat de docent honger heeft"], correct: 2, explanation: "Het zout werkt dan beter." },
      { question: "Hoe lang wacht ze voordat ze proeft?", options: ["Eén dag", "Twee uur", "Drie weken", "Tien dagen"], correct: 3, explanation: "Na tien dagen proeft ze een klein lepeltje." },
      { question: "Waarbij eet ze de zuurkool?", options: ["Bij aardappelen", "Bij ijs", "Bij cake", "Bij soep alleen"], correct: 0, explanation: "Ze eet het bij aardappelen." }
    ]
  },
  {
    id: "comp-041",
    ...
    vocab: [
      ...
      { word: "de oordoppen", en: "earplugs", pos: "noun" },
      { word: "de folder", en: "leaflet", pos: "noun" },
      { word: "de ventilator", en: "fan", pos: "noun" },
      { word: "opvallen", en: "to stand out / be noticeable", pos: "verb" }
    ],
    grammarTargets: ["Subordinate clause with 'omdat'", "Separable verb 'terugbellen'"],
    questions: [
      { question: "Waarom slaapt Omar slecht?", options: ["Omdat hij koffie drinkt", "Omdat hij te laat eet", "Sinds een nieuwe weg open is", "Omdat hij verhuist"], correct: 2, explanation: "Sinds een nieuwe weg open is, slaapt hij slecht." },
      { question: "Hoe laat moet hij opstaan?", options: ["Om acht uur", "Om tien uur", "Om twaalf uur", "Om zes uur"], correct: 3, explanation: "Hij moet om zes uur opstaan voor de bakkerij." },
      { question: "Wat stuurt de GGD?", options: ["Een folder over slaap en geluid", "Een pil", "Een rekening", "Een fiets"], correct: 0, explanation: "De GGD stuurt een folder over slaap en geluid." },
      { question: "Waarom zet Omar een ventilator aan?", options: ["Omdat het heel warm is", "Zodat het suizen van de weg minder opvalt", "Omdat de GGD dat eist", "Omdat de ramen kapot zijn"], correct: 1, explanation: "Hij zet een ventilator aan, zodat het suizen minder kan opvallen." }
    ]
  },
  {
    id: "comp-042",
    ...
    vocab: [
      ...
      { word: "het videogesprek", en: "video call", pos: "noun" },
      { word: "boren", en: "to drill", pos: "verb" },
      { word: "het trappenhuis", en: "stairwell", pos: "noun" },
      { word: "afsluiten", en: "to shut down", pos: "verb" }
    ],
    grammarTargets: ["Separable verb 'afsluiten/verzetten'", "Conditional 'als'"],
    questions: [
      { question: "Waarom zet Lina haar laptop op de eettafel?", options: ["Omdat de keuken koud is", "Omdat haar slaapkamer te klein is voor een bureau", "Omdat de buren dat vragen", "Omdat haar laptop kapot is"], correct: 1, explanation: "Haar slaapkamer is te klein voor een bureau." },
      { question: "Wat doet ze als de buren boren?", options: ["Ze belt de politie", "Ze stopt met werken", "Ze verzet een videogesprek naar later", "Ze gaat verhuizen"], correct: 2, explanation: "Ze verzet een videogesprek naar later." },
      { question: "Hoe laat sluit ze haar computer af?", options: ["Om zes uur", "Om acht uur", "Om twaalf uur", "Om vier uur"], correct: 3, explanation: "Om vier uur moet ze haar computer afsluiten." },
      { question: "Wanneer slaapt ze beter?", options: ["Als ze niet tot zes uur doorwerkt", "Als ze tot middernacht werkt", "Als ze koffie drinkt", "Als de radio hard staat"], correct: 0, explanation: "Ze slaapt beter als ze niet tot zes uur doorwerkt." }
    ]
  },
  {
    id: "comp-043",
    ...
    grammarTargets: ["Separable verb 'opladen'", "Purpose clause with 'zodat'"],
    questions: [
      { question: "Welk bedrag kiest Dilek?", options: ["Tien euro", "Vijftig euro", "Twintig euro", "Vijf euro"], correct: 2, explanation: "Ze kiest twintig euro." },
      { question: "Wat doet ze als de automaat haar pas weigert?", options: ["Ze belt de politie", "Ze gaat lopen", "Ze koopt een auto", "Ze probeert een andere pinpas"], correct: 3, explanation: "Ze probeert een andere pinpas." },
      { question: "Hoe hoog is het saldo daarna?", options: ["Tweeëntwintig euro", "Nul euro", "Honderd euro", "Twee euro"], correct: 0, explanation: "Het staat op tweeëntwintig euro." },
      { question: "Waarom gaat ze bij het raam zitten?", options: ["Omdat het warmer is", "Zodat ze de velden kan zien", "Omdat haar tas nat is", "Omdat de conducteur dat vraagt"], correct: 1, explanation: "Ze gaat bij het raam zitten, zodat ze de velden kan zien." }
    ]
  },
  {
    id: "comp-044",
  ...
  },
  {
    ...
    vocab: [
      ...
      { word: "de enquête", en: "survey", pos: "noun" },
      { word: "de schommel", en: "swing", pos: "noun" },
      { word: "de ketting", en: "chain", pos: "noun" },
      { word: "anoniem", en: "anonymous", pos: "adjective" }
    ],
    grammarTargets: ["Conditional 'als'", "Subordinate clause with 'omdat'"],
    questions: [
      { question: "Hoe vaak komt de nieuwsbrief?", options: ["Elke dag", "Elk jaar", "Elke maand", "Nooit"], correct: 2, explanation: "Het wijkcentrum stuurt elke maand een nieuwsbrief." },
      { question: "Waarom is de schommel kapot volgens Kees?", options: ["Omdat het regent", "Omdat hij te zwaar is", "Omdat de gemeente sluit", "Omdat een ketting ontbreekt"], correct: 3, explanation: "Een ketting ontbreekt." },
      { question: "Hoe staat zijn opmerking in de nieuwsbrief?", options: ["Anoniem", "Met zijn foto", "Met zijn adres", "Helemaal niet"], correct: 0, explanation: "Zijn opmerking staat anoniem in de nieuwsbrief." },
      { question: "Waarom print Kees de pagina?", options: ["Omdat hij een toets heeft", "Zodat hij de datum van de ruilmarkt niet vergeet", "Omdat de printer nieuw is", "Omdat hij verhuist"], correct: 1, explanation: "Hij print de pagina, zodat hij de datum niet vergeet." }
    ]
  },
  {
    id: "comp-046",
    ...
    vocab: [
      ...
      { word: "de tocht", en: "draught", pos: "noun" },
      { word: "de tochtstrip", en: "draught excluder", pos: "noun" },
      { word: "de vergoeding", en: "allowance / reimbursement", pos: "noun" },
      { word: "het voorschot", en: "advance payment", pos: "noun" }
    ],
    grammarTargets: ["Separable verb 'binnenkomen'", "Purpose clause with 'zodat'"],
    questions: [
      { question: "Waar maakt Rosa een afspraak?", options: ["Bij de bakker", "Bij het energieloket van de gemeente Sittard", "Bij de tandarts", "Bij school"], correct: 1, explanation: "Ze maakt een afspraak bij het energieloket van de gemeente Sittard." },
      { question: "Wat meet de adviseur?", options: ["Haar bloeddruk", "Haar inkomen", "De tocht bij het raam", "De tuin"], correct: 2, explanation: "Hij meet de tocht bij het raam." },
      { question: "Wat krijgt Rosa voor de strips?", options: ["Een fiets", "Een nieuwe ketel", "Niets", "Een kleine vergoeding"], correct: 3, explanation: "Ze krijgt een kleine vergoeding voor de strips." },
      { question: "Wat gebeurt er de volgende maand met haar voorschot?", options: ["Het is iets lager", "Het verdubbelt", "Het verdwijnt", "Het wordt contant"], correct: 0, explanation: "De volgende maand is haar voorschot iets lager." }
    ]
  },
  {
    id: "comp-047",
    ...
    vocab: [
      ...
      { word: "steriel", en: "sterile", pos: "adjective" },
      { word: "het monster", en: "sample", pos: "noun" },
      { word: "het buisje", en: "small tube", pos: "noun" },
      { word: "het certificaat", en: "certificate", pos: "noun" }
    ],
  ...
  },
  {
    ...
    vocab: [
      ...
      { word: "de loonstrook", en: "payslip", pos: "noun" },
      { word: "het kinderdagverblijf", en: "day-care centre", pos: "noun" },
      { word: "de berekening", en: "calculation", pos: "noun" },
      { word: "corrigeren", en: "to correct", pos: "verb" }
    ],
    grammarTargets: ["Conditional 'als'", "Purpose clause with 'zodat'"],
    questions: [
      { question: "Welke toeslag vragen ze aan?", options: ["Huurtoeslag", "Zorgtoeslag", "Kinderopvangtoeslag", "Studiefinanciering"], correct: 2, explanation: "Ze vragen kinderopvangtoeslag aan." },
      { question: "Hoe corrigeren ze een fout inkomen?", options: ["Met een foto", "Met een briefje", "Met een telefoontje alleen", "Met een loonstrook"], correct: 3, explanation: "Ze corrigeren het met een loonstrook." },
      { question: "Wat komt er een week later binnen?", options: ["Een voorlopige berekening", "Een boete", "Een paspoort", "Een fiets"], correct: 0, explanation: "Een week later komt een voorlopige berekening binnen." },
      { question: "Wanneer past oma op?", options: ["Elke nacht", "Als de opvang vol zit", "Nooit", "Alleen in de zomer"], correct: 1, explanation: "Oma past soms op als de opvang vol zit." }
    ]
  }
];
